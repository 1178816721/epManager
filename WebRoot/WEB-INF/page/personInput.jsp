			...
			<div class="tab table-bordered">
				<div class="tab-head">
					...
					<ul class="tab-nav">
						...
						<li class="active"><a href="#tab-css">增加员工</a> </li>
				...
				<div class="tab-body">
					...
					<div class="tab-panel active" id="tab-css">
						<form action="${pageContext.request.contextPath}/person_save.action" method="post">
							<div class="line">
								<div class="x2">
									<strong>职工工号：</strong>
								</div>
							...
							<div class="line">
								...
								<div class="x3">
									<input type="text" class="input" name="usen" value="${usen }" />
								</div>
								<div class="x7">
							...
							<div class="line">
								...
								<div class="x3">
									<input type="password" class="input" name="psd" value="${psd}" />
								</div>
								<div class="x7">
